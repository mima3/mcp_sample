// https://github.com/localden/min-ts-mcp-auth
...
function createOAuthUrls() {
  console.log("Creating OAuth URLs with config:", CONFIG.auth);
...
const handleSessionRequest = async (
  ...
  console.log('Handling session request:', req.method, req.url);
  const sessionId = req.headers["mcp-session-id"] as string | undefined;
  if (!sessionId || !transports[sessionId]) {
...
app.listen(CONFIG.port, CONFIG.host, () => {
  console.log(`🔐 Authentication server running on ${CONFIG.host}:${CONFIG.port}`);
